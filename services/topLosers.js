...
// Function to convert API response for top losers
function loserResponseConverter(apiResponse) {
...
// Service to get top losers data
async function getTopLosersData() {
    ...
    try {
        ...
        return loserResponseConverter(response.data);
    } catch (error) {
...
module.exports = { getTopLosersData, loserResponseConverter };
