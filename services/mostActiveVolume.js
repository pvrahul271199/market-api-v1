...
// Function to convert API response for most active volume
function mostActiveVolumeResponseConverter(apiResponse) {
...
// Service to get most active volume data
async function getMostActiveVolumeData() {
    const url = 'https://etapi.indiatimes.com/et-screener/intraday-stats';
    const payload = {
        viewId: 6927,
        apiType: "most-active-volume",
        filterValue: [2371],
        filterType: "index",
        sort: [],
        pagesize: 100,
    ...
    try {
        ...
        return mostActiveVolumeResponseConverter(response.data);
    } catch (error) {
...
module.exports = { getMostActiveVolumeData, mostActiveVolumeResponseConverter };
