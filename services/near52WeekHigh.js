...
function highResponseConverter(apiResponse) {
...
// Service to get near 52-week high data
async function getNear52WeekHighData() {
    const url = 'https://etapi.indiatimes.com/et-screener/intraday-stats';
    const payload = {
        viewId: 6933,
        apiType: "near-52-week-high",
        filterValue: [2371],
        filterType: "index",
        sort: [],
        pagesize: 100,
    ...
    try {
        ...
        return highResponseConverter(response.data);
    } catch (error) {
...
module.exports = { getNear52WeekHighData };
