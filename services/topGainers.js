...
function gainerResponseConverter(apiResponse) {
...
// Service to get top gainers data
async function getTopGainersData() {
    ...
    try {
        ...
        return gainerResponseConverter(response.data);
    } catch (error) {
...
module.exports = { getTopGainersData };
