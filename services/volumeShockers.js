...
function volumeShockersResponseConverter(apiResponse) {
...
// Service to get volume shockers data
async function getVolumeShockersData() {
    ...
    try {
        ...
        return volumeShockersResponseConverter(response.data);
    } catch (error) {
...
module.exports = { getVolumeShockersData };
